-- Статистика списка telegram_groups: строки БД vs уникальные чаты (для корректных счётчиков в UI).
-- Вызывается из Nest: supabase.rpc('telegram_groups_list_stats', { ... }).

-- Колонка нужна для фильтра по номеру TG (на старых БД её могло не быть).
