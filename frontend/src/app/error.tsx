...
export default function Error({
  ...
  return (
    ...
    >
      ...
      <p style={{ fontSize: 14, color: '#666', marginBottom: 8, maxWidth: 480 }}>
        {chunkError
          ? CHUNK_LOAD_USER_MESSAGE
          : error?.message || 'Неизвестная ошибка. Подробности записаны в лог.'}
      </p>
      {chunkError ? (
        <p style={{ fontSize: 12, color: '#999', marginBottom: 16, maxWidth: 480 }}>
