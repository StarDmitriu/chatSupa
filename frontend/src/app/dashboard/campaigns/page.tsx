				...
				<div className='camp__one'>
					<section className='camp__one-section camp__one-section--summary'>
						...
						>
							...
							<Link href='/dashboard/campaigns/timing' style={{ fontSize: 12, opacity: 0.75 }}>
								Сводка таблицей →
							</Link>
						</div>
					...
					{/* История и сводки — в Истории */}
					<section className='camp__one-section camp__one-section--cta'>
						<div className='camp__ctaBlock'>
							<p className='camp__ctaText'>Вся история рассылок, сводки по каналам и статусам — в разделе История</p>
							<Button
								type='primary'
								onClick={() => {
